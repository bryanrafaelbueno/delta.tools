...
export function renderManagePlugins(): HTMLElement {
  ...
  el.innerHTML = `
    <div>
      <div class="page-title">Manage plugins</div>
      <div class="page-sub">All the plugins you've installed. Uninstall any time — nothing is locked in.</div>
    </div>
    <div class="panel">
      <div class="plugin-grid" id="manage-grid"><div class="empty">Loading…</div></div>
    </div>
  `;

  const grid = el.querySelector('#manage-grid') as HTMLElement;
  refresh();
